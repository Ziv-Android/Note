...
产品需求的第二层次（feature）：产品实现客户需要的功能的程度，也就是通常说的“卖点”。
产品需求的第三层次（requirement）：是对产品本身的系统需求，分为功能性需求和非功能性需求。

![产品需求的三个层次之间的关系](pic/产品需求三层之间的关系.png)
需求的三个层次之间的跟踪关系：系统需求实现后必须能提供某种功能或能力，帮助形成产品的特性，也就是产品的卖点或客户的购买理由，并最终解决客户的问题。
