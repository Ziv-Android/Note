...
def cv2ImgAddText(img, text, left, top, textColor=(255, 0, 0), textSize=20):
    ...
    # 字体的格式
    fontStyle = ImageFont.truetype("fonts/FangZhengShuSongJianTi-1.ttf", textSize, encoding="utf-8")
    # 绘制文本
...
def main(path, save=False):
    ...
    for i in range(0, len(all_char_imgs)):
        ...
        for j in range(0, len(row_imgs)):
            ...
            # 图片识别
            results = make_model.predict(model, block_imgs, class_name)
